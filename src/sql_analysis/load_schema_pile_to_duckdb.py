...
from src.sql_analysis.semantic_type import get_column_semantic_type
from src.sql_analysis.sql_types import unify_type
...
def load_data():
    ...
    confirm = input("This will remove the old database and import the new data. Do you want to continue? (yes/no): ")
    ...
    """)
    con.execute(f"""
        CREATE TABLE {COLUMNS_TABLE_NAME} (
            id BIGINT {primary_key()},
