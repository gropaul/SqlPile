...
\end{subfigure}
  ...
  \caption{String properties per semantic type for columns with at least 10,000 rows (n=1039). The filtered distinct chars only counts the number of chars that make up 99\% of all chars.}
\end{figure}
