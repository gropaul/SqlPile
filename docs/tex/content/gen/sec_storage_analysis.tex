...
to their larger average size per value. How much larger strongly varies by dataset. After compression, \texttt{FullText} 
and \texttt{Identifier} strings make up ~ 80\% of all \texttt{Text} bytes stored}
