...
Finally, we benchmark LZ4, a general-purpose compression algorithm that performs well across many data 
...
once and therefore does not support random access to individual values.
As the block granularity, we
