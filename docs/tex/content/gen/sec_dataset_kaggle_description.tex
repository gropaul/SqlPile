...
averaging 53,257 rows per table. Huggingface provides 160 
datasets with 160 tables and an average of 100,102 rows per table.
...
Huggingface and Kaggle use very wide tables, with about 9.3 
and 14.2 columns per table, respectively. In contrast, TPC-[H, DS] 
tables average only 15.2 columns, and DBPile tables about 
6.8. For all tables, we limited the extracted data to a maximum of 
...
18.13 GB for Kaggle and 112.07 GB for Huggingface.